...
const entries: Record<TableId, TableRegistryEntry> = {
  'history-games': {
    ...
    columns: [
      ...
      enumColumn('type', 'Type', ['Regular', 'Playoff', 'Last place', 'Last Place'], { width: 112 }),
    ...
    quickFilters: [
      ...
      { id: 'saunders', label: 'Last place', group: 'season-type', test: isSaunders },
  ...
  'history-weeks': {
    ...
    columns: [
      ...
      enumColumn('type', 'Type', ['Regular', 'Playoff', 'Last place', 'Last Place'], { hideOnMobile: true }),
  ...
  'history-seasons': {
    ...
    quickFilters: [
      ...
      { id: 'saunders', label: 'Last-place seasons', group: 'outcome', test: row => row.saunders === true },
  ...
  'rivalry-games': {
    ...
    columns: [
      ...
      number('season', 'Season'),
      number('week', 'Week'),
      enumColumn('type', 'Type', ['Regular', 'Playoff', 'Last place', 'Last Place']),
      text('round', 'Round', { hideOnMobile: true }),
      text('winner', 'Winner'),
  ...
  'draft-rows': {
    ...
    columns: [
      ...
      enumColumn('outcome', 'Outcome', ['Champion', 'Top 3', 'Playoffs', 'Last place', 'Missed playoffs']),
    ],
    defaultSorting: [{ id: 'season', desc: true }],
    defaultPinned: ['owner'],
    defaultPageSize: 25,
    quickFilters: [
      ...
      { id: 'saunders', label: 'Last-place teams', group: 'outcome', test: row => row.saunders === true },
    ],
    builtInViews: [

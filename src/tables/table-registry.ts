...
const entries: Record<TableId, TableRegistryEntry> = {
  'history-games': {
    ...
    columns: [
      ...
      enumColumn('type', 'Type', ['Regular', 'Playoff', 'Last place'], { width: 112 }),
  ...
  'history-weeks': {
    ...
    columns: [
      ...
      enumColumn('type', 'Type', ['Regular', 'Playoff', 'Last place'], { hideOnMobile: true }),
  ...
  'rivalry-games': {
    ...
    columns: [
      ...
      number('season', 'Season'),
      number('week', 'Week'),
      enumColumn('type', 'Type', ['Regular', 'Playoff', 'Last place']),
      text('round', 'Round', { hideOnMobile: true }),
      text('winner', 'Winner'),

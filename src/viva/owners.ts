...
export const VIVA_OWNERS: readonly VivaOwnerConfig[] = [
  ...
  { canonical: 'Joe', aliases: [], displayName: 'Joe', imageKey: image('Joe'), imageAlt: 'Joe', theme: theme('Joe', '#2563eb', '#60a5fa', '#eff6ff', 'rgba(96,165,250,.16)'), titleNotes: { 'saunders:2015': 'Last-place matchup data incorrect' }, active: true, shotgunDisplayName: 'Joe', historicalExclusion: false },
  ...
  { canonical: 'Will', aliases: ["Will's Wild Team", 'WWT', 'wacalderwood', 'Calderwood'], displayName: 'Will', imageKey: null, imageAlt: 'Will', theme: theme('Will', '#475569', '#94a3b8', '#f8fafc', 'rgba(148,163,184,.16)'), titleNotes: {}, active: true, shotgunDisplayName: 'Will', historicalExclusion: false },
